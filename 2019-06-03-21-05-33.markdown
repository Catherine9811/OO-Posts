...
**Time: 2019-06-03 21:05:33**

> “Critical Errors Occurred!”

## I've Fixed This Error
<div>Corresponding File: <label id="file">2019-06-03-21-05-33.markdown</label><br>Click Me To Resolve: <button class="btn" id="delete" onclick="del()"></button></div>
...
```
[!] FAILED On Line 38
[!] ERROR: Line 38 {Ok, implement interfaces of class "iPhone" are (Electronics, Microwave).} -> ['sdy', 'bxy', 'mjl', 'qyj', 'wsyc', 'wsy', 'qr']
[!] ERROR: Line 38 {Ok, implement interfaces of class "iPhone" are ().} -> ['lzh']
```
