...
**Time: 2019-06-18 21:59:12**

> “Critical Errors Occurred!”

## I've Fixed This Error
<div>Corresponding File: <label id="file">2019-06-18-21-59-12.markdown</label><br>Click Me To Resolve: <button class="btn" id="delete" onclick="del()"></button></div>
...
```
[!] FAILED On Line 528
[!] ERROR: Line 528 {Ok，state count of statemachine "OneState" is 1.} -> ['ws', 'sdy', 'mjl']
[!] ERROR: Line 528 {Ok，state count of statemachine "OneState" is 0.} -> ['bxy']
```
